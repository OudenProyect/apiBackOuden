 ...
 */
final class Version20230125155354 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE Houses (id INT AUTO_INCREMENT NOT NULL, type enum(\'Rustic Property\',\'Castle\',\'Palace\',\'Country house\',\'Town House\',\'Tower\',\'Mansion\'), n_bedrooms INT NOT NULL, toilets INT NOT NULL, state enum(\'To reform\',\'In good condition\'), m2 INT NOT NULL, energy_consum enum(\'A\',\'B\',\'C\',\'D\',\'E\',\'F\',\'G\',\'In process\',\'External property\',\'No data yet\'), year_construction INT DEFAULT NULL, price DOUBLE PRECISION NOT NULL, community_spend DOUBLE PRECISION DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE Publications (id INT AUTO_INCREMENT NOT NULL, id_company_id INT NOT NULL, location_id INT NOT NULL, title VARCHAR(100) NOT NULL, description LONGTEXT NOT NULL, date DATE NOT NULL, hour TIME NOT NULL, INDEX IDX_2A49E10C32119A01 (id_company_id), UNIQUE INDEX UNIQ_2A49E10C64D218E (location_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE Users (id INT AUTO_INCREMENT NOT NULL, cif_company_id INT DEFAULT NULL, name VARCHAR(50) NOT NULL, email VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', img_profile LONGTEXT DEFAULT NULL, password VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_D5428AEDE7927C74 (email), UNIQUE INDEX UNIQ_D5428AEDF0599129 (cif_company_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE Publications ADD CONSTRAINT FK_2A49E10C64D218E FOREIGN KEY (location_id) REFERENCES Locations (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE Publications DROP FOREIGN KEY FK_2A49E10C64D218E');
