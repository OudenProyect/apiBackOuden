 ...
 */
final class Version20230320150003 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE Houses (id INT AUTO_INCREMENT NOT NULL, location_id INT DEFAULT NULL, type enum(\'Rustic Property\',\'Castle\',\'Palace\',\'Country house\',\'Town House\',\'Tower\',\'Mansion\'), n_bedrooms INT NOT NULL, toilets INT NOT NULL, state enum(\'To reform\',\'In good condition\'), m2 INT NOT NULL, energy_consum enum(\'A\',\'B\',\'C\',\'D\',\'E\',\'F\',\'G\',\'In process\',\'External property\',\'No data yet\'), year_construction INT DEFAULT NULL, price DOUBLE PRECISION NOT NULL, community_spend DOUBLE PRECISION DEFAULT NULL, UNIQUE INDEX UNIQ_927BF0FD64D218E (location_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
