...
#[ORM\Entity(repositoryClass: LocationServicesRepository::class)]
class LocationServices
{
    ...
    #[ORM\ManyToMany(targetEntity: House::class, mappedBy: 'areaServices')]
